...
use super::super::{
    ...
    PermissionDetail, PermissionSource, RoleAssignmentService, RoleDetail, RoleEntity,
    RolePolicyRepository, UpdateUserAdminRequest, UserAdminError, UserAdminResult,
