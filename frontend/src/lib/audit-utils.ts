...
export const AUDIT_ACTION_LABELS: Record<string, () => string> = {
  ...
  'permission.update': () => m['audit.action_permission_update'](),
  ...
  'realm_config.update': () => m['audit.action_realm_config_update'](),
  'realm_config.delete': () => m['audit.action_realm_config_delete'](),
  ...
  'totp_config.update': () => m['audit.action_totp_config_update'](),
  'email_otp_config.update': () => m['audit.action_email_otp_config_update'](),
