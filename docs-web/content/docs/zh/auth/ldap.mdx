...
Turnstile 按 Client App 配置执行，和邮箱验证码登录相同，见 [Custom User UI](/docs/zh/integration/custom-user-ui)。
...
- [邮箱验证码登录](/docs/zh/auth/email-otp) — 另一种替代第一因素，状态端点和登录页显隐是同一套模式
- [Custom User UI](/docs/zh/integration/custom-user-ui) — 自建前端路径，包括 Turnstile 渲染和 token 存储
- [配置](/docs/zh/configuration) — Realm 设置和配置行的通用读写
