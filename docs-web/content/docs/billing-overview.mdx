...
| `granted_role_ids` | Roles auto-granted on payment success. Empty = no role grant; see the [paywall configuration guide](/docs/billing-paywall) |
...
- [Paywall configuration guide](/docs/billing-paywall) — granted roles on a mapping: payment grants, refunds revoke, and how your application checks the wall
